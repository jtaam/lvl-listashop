        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="nav-item"><a href="{{route('cart.index')}}" class="cart" style="position: relative"><i class="lnr lnr lnr-cart"></i> <span class="badge cart-badge" style="color: #c5322d; top: -3px; right: -20px; position: absolute;">{{Cart::count()}}</span></a></li>
